...
// CODE HERE
message['text'] = 'I fart in your general direction'
...
// CODE HERE
var myFriends = ['Nick', 'Jacquie', 'Scott', 'Jamal']

// #6 Add a fifth friends name to the end of your myFriends array

// CODE HERE
myFriends.push('James')
...
function evensOnly() {
  // CODE HERE
  return myNumbers.filter(function(x){
    return x%2==0
  });
}
...
var trueFriends = peopleIknow.filter(function(x){
  return x.friend
})
